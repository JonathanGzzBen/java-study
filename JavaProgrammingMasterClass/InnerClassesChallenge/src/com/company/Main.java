...
public class Main {
    ...
    // Instead of using an ArrayList to hold its tracks, it will use an inner
    // class called SongList.
    // The inner SongList class will use an ArrayList and will provide a method
    // to add a song.
